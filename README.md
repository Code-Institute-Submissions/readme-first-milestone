...
This is my First Milestone Project. I created a website for virtual experience company. It is designed to show the different team-building experiences and to explain the value of such activities to the visitors of the website.
<h2 align="center"></h2>
...
-   ### User stories
    ...
    -   #### Frequent User Goals
        ...
        2. As a Frequent User, I want to check to see if someone joined the team.
...
-   ### Design
    ...
    -   #### Typography
        -   The Droid Serif font is the main font used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly. Montserrat is a clean font used frequently in programming, so it is both attractive and appropriate.
    -   #### Imagery
        -   Imagery is important. The large, background image is designed to be striking and catch the user's attention. I also wanted it to gave people the feeling of working from home, and digital experience.
